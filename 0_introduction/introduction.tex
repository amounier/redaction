...
\section{Buildings \& climate change worldwide} % (fold)
\label{sec:buildings_&_climate_change_worldwide}

% section buildings_&_climate_change_worldwide (end)

\section{Adaptation and mitigation of climate change for the french building sector} % (fold)
\label{sec:adaptation_and_mitigation_of_climate_change_for_the_french_building_sector}

    

% section adaptation_and_mitigation_of_climate_change_for_the_french_building_sector (end)

\section{Research tools} % (fold)
\label{sec:outils_de_recherche}

    \subsection{Interdisciplinarity prospective} % (fold)
    \label{sub:interdisciplinarity_prospective}
    
    % subsection interdisciplinarity_prospective (end)

    \subsection{Energy Performance Certificate : a tool for housing stock evaluation} % (fold)
    \label{sub:energy_performance_certificate_a_tool_for_housing_stock_evaluation}
    
    % subsection energy_performance_certificate_a_tool_for_housing_stock_evaluation (end)

% section outils_de_recherche (end)

\section{PhD thesis structure} % (fold)
\label{sec:phd_thesis_structure}

% section phd_thesis_structure (end)
