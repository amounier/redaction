...
\section{Conclusions \& key results} % (fold)
\label{sec:conclusions_&_key_results}

% section conclusions_&_key_results (end)

\section{Public policy recommendations} % (fold)
\label{sec:public_policy_recommendations}

% section public_policy_recommendations (end)

\section{Discussions \& further research} % (fold)
\label{sec:discussions}

    \subsection{Maladaptation concept} % (fold)
    \label{sub:concept_of_maladaptation}
    
    % subsection concept_of_maladaptation (end)

    \subsection{Effects of climate on socio-spatial demography} % (fold)
    \label{sub:effects_of_climate_on_socio_spatial_demography}
    
    % subsection effects_of_climate_on_socio_spatial_demography (end)

    \subsection{Role of the Architectes des Bâtiments de France} % (fold)
    \label{sub:role_of_the_architectes_des_bâtiments_de_france}
    
    % subsection role_of_the_architectes_des_bâtiments_de_france (end)

    \subsection{Ecosystems in the renovation and real estate sectors} % (fold)
    \label{sub:the_ecosystem_of_the_renovation_sector}
    
    % subsection the_ecosystem_of_the_renovation_sector (end)
