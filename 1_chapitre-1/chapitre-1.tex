...
% Titre ---------------------------------------
\date{\today}
\title{Determinants of air conditioning adoption and its role in future energy
demand in the French residential sector}
...
\keywords{Adoption, Air-conditioning, Adaptation, Energy}
...
\clearpage
\section{Descriptive analysis of air conditioning in mainland France} % (fold)
\label{sec:descriptive_analysis_of_air_conditioning_in_mainland_france}

    \subsection{Socio-geographical distribution} % (fold)
    \label{sub:socio_geographical_distribution}
    
    % subsection socio_geographical_distribution (end)

    \subsection{Historical sales of different types of systems} % (fold)
    \label{sub:historical_sales_of_different_types_of_systems}
    
    % subsection historical_sales_of_different_types_of_systems (end)

% section descriptive_analysis_of_air_conditioning_in_mainland_france (end)

\clearpage
\section{Equipment and adoption modelling} % (fold)
\label{sec:equipment_and_adoption_modelling}

    \subsection{Construction of the building stock} % (fold)
    \label{sub:construction_of_the_building_stock}
    
    % subsection construction_of_the_building_stock (end)

    \subsection{Adoption behaviour rules} % (fold)
    \label{sub:adoption_behaviour_rules}
    
    % subsection adoption_behaviour_rules (end)

% section equipment_and_adoption_modelling (end)

\clearpage
\section{Integrated air conditioning development scenarios with Res-IRF} % (fold)
\label{sec:integrated_air_conditioning_development_scenarios_with_res_irf}



% section integrated_air_conditioning_development_scenarios_with_res_irf (end)
