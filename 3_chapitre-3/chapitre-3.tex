...
% Titre ---------------------------------------
\date{\today}
\title{Integrated modelling of public subsidies for the renovation of buildings to
coordinate mitigation and adaptation to climate change.}
...
\keywords{Public policy, Retrofit, Adaptation, Mitigation}
